...
// ===== Option 1: Handle CORS with explicit OPTIONS handler =====
...
app.use((req, res, next) => {
  if (req.method === "OPTIONS") {
    ...
    return res.sendStatus(200); // respond immediately to OPTIONS
  }
  next();
});

// Standard CORS for all other requests
app.use(cors({
